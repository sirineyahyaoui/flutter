...
String extractTime(String inputString) {
  RegExp timePattern = RegExp(r'(\d{1,2}):(\d{2})\s*(?:AM|PM)?', // Matches 12-hour format time
      caseSensitive: false);
...
Future<void> setConfigData(SiteConfig configData) async {
  setValue(PRICE_DECIMAL_POINTS, configData.digitafterDecimalPoint.validate().toInt());
