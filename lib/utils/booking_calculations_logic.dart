...
BookingAmountModel finalCalculations({
  ...
  data.finalSubTotal =
      (data.finalTotalServicePrice - data.finalDiscountAmount - data.finalCouponDiscountAmount + data.finalServiceAddonAmount).toStringAsFixed(getIntAsync(PRICE_DECIMAL_POINTS)).toDouble();
