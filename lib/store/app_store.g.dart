...
mixin _$AppStore on _AppStore, Store {
  ...
  String get privacyPolicy {
    return '''
<p>En accédant aux produits et services disponibles sur ce site web et en effectuant des commandes, vous reconnaissez et acceptez d'être lié par les conditions générales présentées ci-dessous. Ces conditions s'appliquent à l'ensemble du site web ainsi qu'à toute communication ultérieure entre vous et IdiLimin. L'équipe d'IdiLimin décline toute responsabilité en cas de dommages directs, indirects, accessoires ou consécutifs, y compris, mais sans s'y limiter, la perte de données ou de profits, résultant de l'utilisation des éléments de ce site.</p>

<p>IdiLimin ne sera pas tenu responsable de tout résultat découlant de l'utilisation de nos ressources. Nous nous réservons le droit de modifier les prix et de réviser la politique d'utilisation des ressources à tout moment.</p>

<p><strong>Produits et services :</strong>
<br>
Tous les produits et services disponibles sur ce site web sont fournis par IdiLimin. Vous pouvez accéder à vos téléchargements depuis votre tableau de bord respectif. Veuillez noter que nous ne fournissons pas de support pour les logiciels, plugins ou bibliothèques tiers que vous utilisez avec nos produits.</p>

<p><strong>Sécurité :</strong>
<br>
IdiLimin ne traite aucun paiement de commande.</p>

<p><strong>Politique en matière de cookies :</strong>
<br>
Notre site web utilise des cookies. En utilisant notre site web et en acceptant cette politique, vous consentez à notre utilisation de cookies conformément aux termes de cette politique.</p>

<p>Nous utilisons des cookies de session pour personnaliser le site web pour chaque utilisateur.</p>

<p><strong>Propriété :</strong>
<br>
La propriété des produits est régie par la licence d'utilisation.</p>

<p><strong>Modifications des conditions :</strong>
<br>
Nous nous réservons le droit de modifier ou de mettre à jour nos conditions d'utilisation sans préavis. Toute modification sera publiée sur cette page et les utilisateurs pourront consulter la dernière version ici.</p>
  ''';
  }
  ...
  String get termConditions {
    return '''
<p>En accédant aux produits et services disponibles sur ce site web et en effectuant des commandes, vous reconnaissez et acceptez d'être lié par les conditions générales présentées ci-dessous. Ces conditions s'appliquent à l'ensemble du site web ainsi qu'à toute communication ultérieure entre vous et IdiLimin. 
L'équipe d'IdiLimin décline toute responsabilité en cas de dommages directs, indirects, accessoires ou consécutifs, y compris, mais sans s'y limiter, la perte de données ou de profits, résultant de l'utilisation des éléments de ce site.</p>
...
<p><strong>Politique en matière de cookies :</strong>
<br>
Notre site web utilise des cookies. En utilisant notre site web et en acceptant cette politique, vous consentez à notre utilisation de cookies conformément aux termes de cette politique. Nous utilisons des cookies de session pour personnaliser le site web pour chaque utilisateur.</p>
